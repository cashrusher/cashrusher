...
public class HibernateInterceptor implements MethodInterceptor {
    ...
    private static final int FLUSH_NEVER = 0;

    private static final int FLUSH_AUTO = 1;

    private static final int FLUSH_EAGER = 2;

    private static final int FLUSH_COMMIT = 3;

    private static final int FLUSH_ALWAYS = 4;
