...
public class StockClient {
    ...
    public static void main(String[] args) throws HttpException, IOException {
        ...
        String api_key = "14d0881c-68b8-4de7-8ef5-b2140ba2780c";  //OKCoin申请的apiKey
        String secret_key = "0440198DB0B9D02BBF0F240AB220208A";  //OKCoin 申请的secret_key
         ...
         *
         */
        IStockRestApi stockGet = new StockRestApiService(url_prex);
         ...
         *
         */
        IStockRestApi stockPost = new StockRestApiService(url_prex, api_key, secret_key);
        ...
        //现货下单交易
        String tradeResult = stockPost.trade("btc_cny", "buy", "50", "0.02");
